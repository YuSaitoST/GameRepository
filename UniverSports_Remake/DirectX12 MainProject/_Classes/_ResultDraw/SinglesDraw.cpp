...
void SinglesDraw::Render() {
	...
	DX9::SpriteBatch->DrawSimple(sp_playerName_.Get(), DirectX::XMFLOAT3(SERIALS::PLAYER::POS_X, SERIALS::PLAYER::POS_Y, (int)US2D::Layer::RESULT::UI_WINNERTEXT), RECT(player_rect_x[0], 0, player_rect_x[0] + SERIALS::PLAYER::RECT_X, SERIALS::PLAYER::RECT_Y));
}